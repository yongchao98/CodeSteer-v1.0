...
from typing import Any, Dict, Generator, List, Optional, Sequence, Tuple, AsyncGenerator
...
class ChatModel:
    ...
    def stream_chat_with_probs(
        ...
        **input_kwargs,
        ...
        generator = self.astream_chat_with_probs(messages, system, tools, images, videos, **input_kwargs)
        while True:
            try:
                task = asyncio.run_coroutine_threadsafe(generator.__anext__(), self._loop)
                yield task.result()
    ...
    async def astream_chat_with_probs(
        self,
        messages: Sequence[Dict[str, str]],
        system: Optional[str] = None,
        tools: Optional[str] = None,
        ...
        videos: Optional[Sequence["VideoInput"]] = None,
        **input_kwargs,
    ) -> AsyncGenerator[Tuple[str, Dict[str, float]], None]:
        async for token, probs in self.engine.stream_chat_with_probs(messages, system, tools, images, videos, **input_kwargs):
            yield token, probs
